(ns musubi.repository-contract-test
...
(deftest canonical-repository-shape
  (doseq [path ["manifest.edn" "identity.edn" "dependencies.edn"
                "repository-contracts.edn" "registry/ceremony-recognition.seed.edn"]]
  ...
  (is (= 54 (count (get (edn/read-string
                          (slurp "registry/ceremony-recognition.seed.edn"))
                        "recognitions")))))
